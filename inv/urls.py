...
from .views import CategoriaView, CategoriaNew, CategoriaEdit, CategoriaDel, SubCategoriaView, SubCategoriaNew, SubCategoriaEdit, SubCategoriaDel, MarcaView, MarcaNew, MarcaEdit, marca_inactivar, UMView, UMEdit, UMNew, UMEdit, um_inactivar, ProductoView, ProductoNew, ProductoEdit, producto_inactivar
