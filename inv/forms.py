...
from .models import Categoria, SubCategoria, Marca, UnidadesMedidas, Producto
...
class UMForm(forms.ModelForm):
    ...
    class Meta:
        ...
        fields = ['descripcion', 'estado']
        label = { 'descripcion' : 'Descripcion Unidad de Medida', 
                    'estado' : 'Estado'}
...
class ProductoForm(forms.ModelForm):
    class Meta:
        ...
        fields = ['codigo', 'codigo_barra', 'descripcion', 'estado',
                    'precio', 'existencia', 'ultima_compra', 'marca', 'sub_categoria',
                    'unidad_medida']
        exclude = ['um', 'fm', 'uc', 'fc']
        widget = {'descripcion' : forms.TextInput()}
